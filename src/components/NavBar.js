  ...
  return (
    <div className="w-screen h-[80px] z-10 bg-zinc-100 fixed drop-shadow-lg">
      <div className="px-4 flex justify-between items-center w-full h-full">
        ...
        <a href="/signup"><button className="px-8 py-3 hover:bg-indigo-700 hover:text-white">Sign Up</button></a>
        </div>
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-zinc-100 w-full px-8'}>
        <li><button className="text-black border-none bg-zinc-100 hover:text-gray-600"><Link onClick={handleClose} to="home" smooth={true} duration={500}>Home</Link></button></li>
        <li><button className="text-black border-none bg-zinc-100 hover:text-gray-600"><Link onClick={handleClose} to="about" smooth={true} offset={-200} duration={500}>About</Link></button></li>
        <li><button className="text-black border-none bg-zinc-100 hover:text-gray-600"><Link onClick={handleClose} to="support" smooth={true} offset={-50} duration={500}>Support</Link></button></li>
        <li><button className="text-black border-none bg-zinc-100 hover:text-gray-600"><Link onClick={handleClose} to="platform" smooth={true} offset={-100} duration={500}>Platforms</Link></button></li>
        <li><button className="text-black border-none bg-zinc-100 hover:text-gray-600"><Link onClick={handleClose} to="pricing" smooth={true} offset={-50} duration={500}>Pricing</Link></button></li>
        <div className="flex flex-col my-4">
          <a href="/signin"><button className="bg-transparent text-indigo-600 px-8 py-3 mb-4 hover:bg-zinc-50">Sign In</button></a>
          <a href="/signup"><button className="px-8 py-3 hover:bg-indigo-700 hover:text-white">Sign Up</button></a>
        </div>
      </ul>
    </div>
