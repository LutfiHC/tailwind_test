...
const GetStarted = () => {
  ...
  return(
    <div className="relative w-full h-screen bg-zinc-900/50">
      ...
      <div className={questionaire === 3 ? "flex justify-center items-center h-full relative" : "hidden"}>
        <form className="lg:max-w-[1024px] w-full mx-auto p-8 bg-zinc-50 sm:max-w-[640px]">
          <h2 className="text-4xl font-bold text-center pt-7 pb-6">LUTFISK</h2>
          <div className="w-full bg-gray-100 rounded-full h-4 dark:bg-gray-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 relative gap-x-2 gap-y-2 pt-8">
            <p className="w-full bg-white text-slate-900 py-12 px-4 rounded-xl shadow-2xl relative">
              <input name="radio_check" className="mx-1 mr-2 mb-6" type="radio" /><b className="text-xl">Standard ($49/month)</b><p>Lorem ipsum dolor</p><p>Lorem ipsum dolor sit amet</p></p>
            <p className="w-full bg-white text-slate-900 py-12 px-4 rounded-xl shadow-2xl relative">
              <input name="radio_check" className="mx-1 mr-2 mb-6" type="radio" /><b className="text-xl">Premium ($89/month)</b><p>Lorem ipsum dolor</p><p>Lorem ipsum dolor sit amet</p><p>Lorem ipsum dolor sit</p><p>Lorem ipsum dolor sit</p><p>Lorem ipsum dolor</p></p>
          </div>
          <div className="flex justify-between pt-20 px-4">
            ...
            <div>
              <button className="border my-5 py-2 px-5 hover:bg-indigo-700 hover:text-white"onClick={(event) => (navigate("/"), event.preventDefault())}>Finish</button>
            </div> 
          </div>
        </form>
      </div> 
